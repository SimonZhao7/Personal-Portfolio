...
const Main = () => {
  ...
  return (
    <section
      id="main"
      className="flex min-h-[calc(100vh-72px)] flex-col items-center justify-center space-y-10"
    >
      <motion.div
      ...
      <div className="flex space-x-2 xs:space-x-4 lg:space-x-8">
        <button onClick={() => router.push("/#about")} className="navBtn">
          About
        </button>
        <button onClick={() => router.push("/#experience")} className="navBtn">
          Experience
        </button>
        <button onClick={() => router.push("/#projects")} className="navBtn">
          Projects
        </button>
        <button onClick={() => router.push("/#skills")} className="navBtn">
          Skills
        </button>
      </div>
    </section>
